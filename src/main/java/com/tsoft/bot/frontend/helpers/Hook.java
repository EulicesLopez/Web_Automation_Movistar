...
import static com.tsoft.bot.frontend.baseClass.web.BaseClass.stepFailNoShoot;
...
public class Hook extends Listener {
	...
	private static final String CHROME_DRIVER 	= "/src/main/resources/driver/chrome/86.0/chromedriver.exe";
